...
WebUI.setText(findTestObject('Page_Login  Schoolcomms (1)/input_Username'), 'Hillier82')
...
WebUI.takeScreenshot('C:\\Windows\\Temp\\KatalonCaptures\\Active_Payment_Landing_Page.png')
